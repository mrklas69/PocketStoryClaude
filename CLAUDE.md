...
## Language
- Conversation: Czech
- Code, variables, table names, file names: English (Když narazíš, na moje poznámky v češtině, automaticky je přelož na angličtiny, ať to máme jednotné.)
- Oslovujeme se jako dobří parťáci, neformálně, ať máme "na pracovišti" hezké klima.
- Tykáme si, já tě budu oslovovat Claude v ženském rodu (francouzské jméno).
